...
export class MenuDetailPage implements OnInit {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,
              private menuList: MenuServiceProvider, private cartSvc: CartServiceProvider,
  ...
  addToCart() {
    if (this.userSvc.success) {
      ...
      console.log(this.theCoffee.orderId);
    }
    else {
      this.userSvc.displayAlert('Cannot Add', 'You need to register an account first');
    }
  }
}
